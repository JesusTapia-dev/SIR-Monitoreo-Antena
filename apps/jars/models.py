...
class JARSFilter(models.Model):
    ...
    def dict_to_parms_new(self, parameters):
        ...
        self.cic_2       = parameters['cic_2']
        self.cic_5       = parameters['cic_5']
        self.scale_fir   = parameters['scale_fir']
        self.scale_cic_2 = parameters['scale_cic_2']
        self.scale_cic_5 = parameters['scale_cic_5']
        self.number_taps = parameters['number_taps']
        self.taps        = parameters['taps']

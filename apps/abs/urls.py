...
urlpatterns = (
    ...
    path('<int:id_conf>/mqtt', views.abs_conf_mqtt, name='url_abs_conf_mqtt'),
    ...
    path('<int:id_conf>/change_beam_mqtt/<int:id_beam>/', views.change_beam_mqtt, name='url_change_beam_mqtt'),

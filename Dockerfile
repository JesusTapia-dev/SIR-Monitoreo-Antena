...
RUN apt-get clean && apt-get update && apt-get install -y --no-install-recommends \
    ...
    # && pip install -v --timeout 120 --no-cache-dir ./psycopg_binary-3.1.8-cp311-cp311-musllinux_1_1_x86_64.whl \
    ...
    # && pip install -v --timeout 120 --no-cache-dir ./numpy-1.24.1-pp38-pypy38_pp73-manylinux_2_17_x86_64.manylinux2014_x86_64.whl \
    # && pip install -v --timeout 120 --no-cache-dir ./matplotlib-3.6.3-pp39-pypy39_pp73-manylinux_2_17_x86_64.manylinux2014_x86_64.whl \
